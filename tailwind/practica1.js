...
function ponericono1() {
  ...
  if (caja1.value == undefined) {
    caja1.innerHTML = `<p class = "text-9xl flex justify-center content-center">${a}</p>`;
...
function ponericono2() {
  ...
  if (caja2.value == undefined) {
    caja2.innerHTML = `<p class = "text-9xl flex justify-center content-center">${a}</p>`;
...
function ponericono3() {
  ...
  if (caja3.value == undefined) {
    caja3.innerHTML = `<p class = "text-9xl flex justify-center content-center">${a}</p>`;
...
function ponericono4() {
  ...
  if (caja4.value == undefined) {
    caja4.innerHTML = `<p class = "text-9xl flex justify-center content-center">${a}</p>`;
...
function ponericono5() {
  ...
  if (caja5.value == undefined) {
    caja5.innerHTML = `<p class = "text-9xl flex justify-center content-center">${a}</p>`;
...
function ponericono6() {
  ...
  if (caja6.value == undefined) {
    caja6.innerHTML = `<p class = "text-9xl flex justify-center content-center">${a}</p>`;
...
function ponericono7() {
  ...
  if (caja7.value == undefined) {
    caja7.innerHTML = `<p class = "text-9xl flex justify-center content-center">${a}</p>`;
...
function ponericono8() {
  ...
  if (caja8.value == undefined) {
    caja8.innerHTML = `<p class = "text-9xl flex justify-center content-center">${a}</p>`;
...
function ponericono9() {
  ...
  if (caja9.value == undefined) {
    caja9.innerHTML = `<p class = "text-9xl flex justify-center content-center">${a}</p>`;
